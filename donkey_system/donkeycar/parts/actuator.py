...
class MOCK_Adafruit_PCA9685():
    """ 
    This is the mock hardware class, from Adafruit
    See: https://github.com/adafruit/Adafruit_Python_PCA9685/blob/master/Adafruit_PCA9685/PCA9685.py
    """
    def __init__(self):
        pass
...
class MOCK_PCA9685(object):
    ''' 
    This is the Mock PCA class from Donkey
    '''
    def __init__(self, channel, frequency=60):
        self.pwm = MOCK_Adafruit_PCA9685()
        self.pwm.set_pwm_freq(frequency)
        self.channel = channel
